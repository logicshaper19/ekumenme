...
class EnhancedEvapotranspirationService:
...
evapotranspiration_service = EnhancedEvapotranspirationService()
...
calculate_evapotranspiration_tool_enhanced = StructuredTool.from_function(
