...
class EnhancedAMMService:
    ...
    def __init__(self):
        ...
        logger.info("Initialized EnhancedAMMService")
...
_amm_service = EnhancedAMMService()
...
database_integrated_amm_tool_enhanced = StructuredTool.from_function(
