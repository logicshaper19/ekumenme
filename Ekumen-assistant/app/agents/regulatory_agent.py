...
from ..prompts.regulatory_prompts import get_regulatory_react_prompt
...
class RegulatoryIntelligenceAgent:
    ...
    def __init__(
        ...
        max_iterations: int = 10,  # Increased for complex regulatory checks
        enable_metrics: bool = True
    ):
        """
        Initialize Regulatory Intelligence Agent with sophisticated prompts.
        ...
        Args:
            ...
            max_iterations: Maximum ReAct iterations (default 10 for complex regulatory compliance)
        ...
        logger.info(
            f"✅ Regulatory Intelligence Agent initialized: "
    ...
    def _create_agent(self):
        """Create LangChain ReAct agent with sophisticated regulatory prompt."""
        prompt = self._get_prompt_template()
        return create_react_agent(self.llm, self.tools, prompt)

    def _get_prompt_template(self) -> ChatPromptTemplate:
        """
        Get sophisticated regulatory-specific prompt template for ReAct agent.

        Uses the centralized prompt system from app/prompts/Regulatory_prompts.py
        which includes:
        ...
        Returns:
            ChatPromptTemplate configured for regulatory intelligence
        """
        # Get sophisticated prompt from centralized prompt system
        return get_regulatory_react_prompt(include_examples=self.enable_dynamic_examples)
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        Example:
            >>> agent.get_metrics()
            {
                ...
                'success_rate': 80.0,
                'avg_iterations': 3.5,
                'tool_usage': {'get_Regulatory': 8, 'calculate_disease_identification': 5},
    ...
    def reset_metrics(self):
        ...
        if self.enable_metrics:
            ...
            logger.info("Regulatory Agent metrics reset")
