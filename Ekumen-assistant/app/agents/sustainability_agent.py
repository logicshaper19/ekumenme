...
from ..prompts.sustainability_prompts import get_sustainability_react_prompt
...
class SustainabilityIntelligenceAgent:
    ...
    def __init__(
        ...
        max_iterations: int = 10,  # Increased for complex sustainability analysis
        enable_metrics: bool = True
    ):
        """
        Initialize Sustainability Intelligence Agent with sophisticated prompts.
        ...
        Args:
            ...
            max_iterations: Maximum ReAct iterations (default 10 for complex sustainability analysis)
        ...
        logger.info(
            f"✅ Sustainability Intelligence Agent initialized: "
    ...
    def _create_agent(self):
        """Create LangChain ReAct agent with sophisticated sustainability prompt."""
        prompt = self._get_prompt_template()
        return create_react_agent(self.llm, self.tools, prompt)

    def _get_prompt_template(self) -> ChatPromptTemplate:
        """
        Get sophisticated sustainability-specific prompt template for ReAct agent.

        Uses the centralized prompt system from app/prompts/Sustainability_prompts.py
        which includes:
        ...
        Returns:
            ChatPromptTemplate configured for sustainability intelligence
        """
        # Get sophisticated prompt from centralized prompt system
        return get_sustainability_react_prompt(include_examples=self.enable_dynamic_examples)
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        Example:
            >>> agent.get_metrics()
            {
                ...
                'success_rate': 80.0,
                'avg_iterations': 3.5,
                'tool_usage': {'get_Sustainability': 8, 'calculate_disease_identification': 5},
    ...
    def reset_metrics(self):
        ...
        if self.enable_metrics:
            ...
            logger.info("Sustainability Agent metrics reset")
