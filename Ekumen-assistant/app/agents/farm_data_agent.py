"""
Farm Data Intelligence Agent - Production-ready with sophisticated prompts.

This agent:
1. Uses 4 production-ready farm data tools
...
from ..prompts.farm_data_prompts import get_farm_data_react_prompt
...
class FarmDataIntelligenceAgent:
    ...
    def __init__(
        ...
        max_iterations: int = 10,  # Increased for complex multi-step analysis
        enable_metrics: bool = True
    ):
        """
        Initialize Farm Data Intelligence Agent with sophisticated prompts.
        ...
        Args:
            ...
            max_iterations: Maximum ReAct iterations (default 10 for complex farm data analysis)
        ...
        logger.info(
            f"✅ Farm Data Intelligence Agent initialized: "
    ...
    def _create_agent(self):
        """Create LangChain ReAct agent with sophisticated farm data prompt."""
        prompt = self._get_prompt_template()
        return create_react_agent(self.llm, self.tools, prompt)

    def _get_prompt_template(self) -> ChatPromptTemplate:
        """
        Get sophisticated farm data-specific prompt template for ReAct agent.

        Uses the centralized prompt system from app/prompts/farm_data_prompts.py
        which includes:
        - Comprehensive farm data expertise
        - ReAct format instructions
        - Few-shot examples
        - Safety reminders

        Returns:
            ChatPromptTemplate configured for farm data intelligence
        """
        # Get sophisticated prompt from centralized prompt system
        return get_farm_data_react_prompt(include_examples=self.enable_dynamic_examples)
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "data_sources": ["MesParcelles", "EPHY", "agri_db"],
            "language": "french",
            "configuration": {
                "max_iterations": self.max_iterations,
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        Example:
            >>> agent.get_metrics()
            {
                ...
                'success_rate': 80.0,
                'avg_iterations': 3.5,
                'tool_usage': {'get_farm_data': 8, 'calculate_performance_metrics': 5},
    ...
    def reset_metrics(self):
        ...
        if self.enable_metrics:
            ...
            logger.info("Farm Data Agent metrics reset")
