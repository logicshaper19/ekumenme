"""
Enhanced Semantic Tool Selection Service
...
class EnhancedSemanticToolSelector:
    """
    ...
    def __init__(self, config_path: Optional[str] = None, model_name: str = "sentence-transformers/all-MiniLM-L6-v2"):
        """Initialize enhanced semantic tool selector."""
...
enhanced_semantic_tool_selector = EnhancedSemanticToolSelector()
